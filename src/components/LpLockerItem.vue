  ...
  <div>
    ...
    <el-main>
      <nav>
        ...
        <router-link class="router-link" tag="span" :to="{ name: 'deep-freezer-listing' }" exact active-class="is-active">
          Deep Freezers
        </router-link>
        <i class="fal fa-angle-right"></i>
      ...
      <div class="page-header row-between">
        <div>
          <h2 style="margin-bottom: 0px">XTZ/CRUNCH</h2>
          <h2
            style="
              color: #191b1f;
              opacity: 0.4;
      ...
      <el-row :gutter="20" type="flex" style="flex-wrap: wrap" class="header-grid-wrapper">
          ...
          <div class="grid-content lp-locker-progress" style="height: 100%;">
            <el-card class="box-card" shadow="never" style="height: 100%;">
              <el-row type="flex" justify="space-between">
                <el-col>
                  <img src="./../assets/svg-icons/xtz-crunch.svg" style="width: 80px; 24px;" />

                  <h2 style="font-size: 20px; margin-bottom:0;">XTZ/ CRUNCH</h2>
                  <div style="margin-top: 14px;">
                    <h2 style="font-size: 20px; margin-bottom:0; color: #1EC37F;">04 March 2021 - 5:51 AM</h2>
                    <h2 style="color: #191B1F; opacity: 0.4; font-size: 14px; margin-bottom: 0px;">Next Unlock Date</h2>
                  </div>
                </el-col>
                <div>
                  <div style="display: flex; align-items: center">
                    <h2
                      style="color: #191B1F; opacity: 0.4; font-size: 14px; margin-bottom: 0px; margin-right: 5px
                    "
                    >
                      tz1s...1363C
                    </h2>
                    <el-button style="background: rgba(25, 27, 31, 0.1); color: #000; border: 0px" type="info" icon="el-icon-copy-document" circle></el-button>
                  </div>
                </div>
              </el-row>
            </el-card>
        ...
        <el-col :xs="24" :sm="12" :lg="6">
          <div class="grid-content" style="height: 100%;">
            <el-card class="box-card" shadow="never" style="height: 100%; background: #f4f4f4;">
        ...
        <el-col :xs="24" :sm="12" :lg="6">
          <div class="grid-content" style="height: 100%;">
            <el-card class="box-card" shadow="never" style="height: 100%;">
              ...
              <el-progress :percentage="27.56" type="circle" :width="48" :stroke-width="8" color="#1EC37F" style="float: right;"></el-progress>
              <div style="font-size: 24px; font-weight: 600; margin-top: 14px; margin-bottom: 8px;">
                137,151.2851
              </div>
        ...
        <el-col :xs="24" :sm="12" :lg="6">
          <div class="grid-content" style="height: 100%;">
            <el-card class="box-card" shadow="never" style="height: 100%;">
              ...
              <div style="font-size: 24px; font-weight: 600; margin-top: 14px; margin-bottom: 8px;">2345 ꜩ</div>
        ...
        <el-col :xs="24" :sm="12" :lg="6">
          <div class="grid-content lp-locker-progress" style="height: 100%;">
            <el-card class="box-card" shadow="never" style="height: 100%;">
              ...
              <el-progress :percentage="54" type="circle" :width="48" :stroke-width="8" color="#555CFF" style="float: right;"></el-progress>
              <div style="font-size: 24px; font-weight: 600; margin-top: 14px; margin-bottom: 8px;">521,475.0109 ꜩ</div>
        ...
        <el-col :xs="24" :sm="12" :lg="6">
          <div class="grid-content" style="height: 100%;">
            <el-card class="box-card" shadow="never" style="height: 100%;">
              <el-avatar shape="circle" :size="48" style="background: #FFCF36; font-size: 24px;">
                <img src="./../assets/svg-icons/lock.svg" style="width: 24px; height: 24px; padding: 12px;" />
              </el-avatar>
              <div style="font-size: 24px; font-weight: 600; margin-top: 14px; margin-bottom: 8px;">
                $17,245,234.23
      ...
      <div style="margin-top: 32px">
        <div class="margin-bottom-24">
          <h2 style="margin-bottom: 0px">Timeline of Unlock(s)</h2>
          <h2
            style="
              color: #191b1f;
              opacity: 0.4;
        ...
        <div class="overflow-table">
          <el-card class="grid-content box margin-bottom-24" style="min-width: max-content">
            <el-row type="flex" align="center" style="align-items: center; min-width: max-content; justify-content: space-between">
              <el-avatar shape="circle" :size="48" style="background: #FFCF36; font-size: 24px; margin-right: 20px">
                <el-avatar shape="circle" :size="48" style="background: #FFCF36; font-size: 24px;">
                  <img src="./../assets/svg-icons/unlock.svg" style="width: 24px; height: 24px; padding: 12px;" />
                </el-avatar>
              </el-avatar>

              <div class="margin-right-50" style="height: max-content">
                <h2 class="unlock-text-light">
                  UNLOCK DATE
                </h2>
                <h2 class="unlock-text">
                  04 Mar 2020 | 5:30 AM
                </h2>
              </div>
              <div class="margin-right-50" style="height: max-content">
                ...
                <h2 class=" unlock-text" style="color: #555CFF;">
                  0.57%
                </h2>
              </div>
              ...
              <div class="margin-right-50" style="height: max-content">
                ...
                <h2 class="unlock-text">685.<span style="opacity:0.4">7564255</span></h2>
              </div>

              <div class="margin-right-50" style="height: max-content; margin-right: 65px">
                <h2 class="unlock-text-light">
                  UNLOCK VALUE
                </h2>
                <h2 class="unlock-text">
