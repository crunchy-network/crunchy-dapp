            ...
            <div class="grid-content" style="height: 100%">
              <el-card class="box-card" shadow="always" style="height: 100%">
                ...
                >
                  ...
                  >
                  <el-col
                    v-if="form.poolTokenName.length && form.poolTokenIsLp"
                    :span="16"
                  >
                    <!-- <el-avatar
                      shape="circle"
                    ...
                    <el-avatar
                      v-if="
                        ...
                        form.poolTokenThumbnailUri.length > 0
                      "
                      :src="form.poolTokenThumbnailUri[1]"
                      fit="cover"
                      shape="circle"
                      :size="40"
                      style="
                  ...
                  >
                    <el-avatar
                      :src="form.poolTokenThumbnailUri"
                      fit="cover"
                      shape="circle"
                      :size="40"
                      style="
                  ...
                  <el-col v-if="form.poolTokenName.length === 0" :span="16"
                    >--</el-col
                  >
                </el-row>
                <el-row
                ...
                >
                  ...
                  <el-col v-if="form.rewardTokenName.length" :span="16">
                    <el-avatar
                      :src="form.rewardTokenThumbnailUri"
                      fit="cover"
                      shape="circle"
                      :size="40"
                      style="
                  ...
                  <el-col v-if="form.rewardTokenName.length === 0" :span="16"
                    >--</el-col
                  >
                </el-row>
                <el-row
                ...
                >
                  ...
                  <el-col v-if="form.rewardTokenAmount" :span="16"
                    ...
                    {{ form.rewardTokenName }}</el-col
                  >
                  <el-col v-if="!form.rewardTokenAmount" :span="16">--</el-col>
                </el-row>
                <el-row
                  type="flex"
                  style="font-size: 14px; margin-bottom: 14px"
                >
                  ...
                  <el-col v-if="rewardAmountPerSecond" :span="16"
                    >{{
                      vueNumberFormat(
                        rewardAmountPerSecond / 10 ** form.rewardTokenDecimals,
                        {
                          prefix: "",
                          decimal: ".",
                          thousand: ",",
                          precision: form.rewardTokenDecimals,
                        }
                      )
                    }}
                    {{ form.rewardTokenName }}</el-col
                  >
                  <el-col v-if="!rewardAmountPerSecond" :span="16">--</el-col>
                </el-row>
                ...
                >
                  ...
                  <el-col
                    v-if="
                      form.serviceFeeId.length === 0 ||
                      form.rewardTokenName.length === 0
                    "
                    :span="16"
                    >--</el-col
                  >
...
export default {
  ...
  methods: {
    ...
    queryPoolTokens(keywords, cb) {
      ...
      if (
        ...
        matches.push({
          ...
          type: "fa1",
          address: "KpoolTokenIsLpT1AafHA1C1vk959wvHWBispY9Y2f3fxBUUo",
          tokenId: 0,
          isLp: true,
          thumbnailUri:
    ...
    handlePoolTokenSelect(i) {
      this.form.poolTokenIsLp = i.isLp;
