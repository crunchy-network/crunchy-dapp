                ...
                <el-col :span="4">
                  <el-row v-if="lp.isLbLp" type="flex" style="flex-wrap: wrap">
                    <div style="width: max-content">
                      ...
                      ></el-avatar>
                      <el-avatar
                        :src="position.poolToken.thumbnailUri"
                        fit="cover"
                        shape="circle"
                        :size="25"
                        style="
                  ...
                  >
                    <div>
                      <el-avatar
                        ...
                        style="
                          ...
                          vertical-align: middle;
                        "
                        :src="position.poolToken.token1.thumbnailUri"
                      ></el-avatar>
                      <el-avatar
                        :src="position.poolToken.token2.thumbnailUri"
                        fit="cover"
                        shape="circle"
                        :size="25"
                        style="
                    ...
                    <span style="color: #555cff">
                      {{ position.poolToken.token1.symbol }}/{{
                        position.poolToken.token2.symbol
                      }}
                    </span>
                  </el-row>
