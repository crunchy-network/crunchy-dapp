                ...
                <template slot="title">
                  ...
                  >
                    <path
                      ...
                      :stroke="defiActive ? '#f15d59' : '#8c8d8f'"
                      stroke-width="1.5"
              ...
              >
                <template slot="title">
                  <svg
                    ...
                    style="margin-right: 8px"
                  >
                    <circle cx="14" cy="14" r="14" fill="#8c8d8f" />
                    <circle cx="22" cy="14" r="3" fill="#191b1f" />
                    <circle cx="22" cy="14" r="3" fill="#191b1f" />
                    <circle cx="6" cy="14" r="3" fill="#191b1f" />
                    <circle cx="6" cy="14" r="3" fill="#191b1f" />
                    <circle cx="14" cy="14" r="3" fill="#191b1f" />
                    <circle cx="14" cy="14" r="3" fill="#191b1f" />
                  </svg>
                  More</template
                >
