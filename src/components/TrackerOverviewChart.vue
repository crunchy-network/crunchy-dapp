...
export default {
  ...
  watch: {
    ...
    'quoteIndex.quoteIndex4h': 'handleQuoteIndexChange',
    'quoteIndex.quoteIndex1d': 'handleQuoteIndexChange',
    'quoteIndex.quoteIndex1Mo': 'handleQuoteIndexChange',
    duration() {
      this.getPrices();
    },
