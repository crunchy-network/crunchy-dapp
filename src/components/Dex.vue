<template>
  <div>
    ...
    <el-main style="margin-top: 138px;">
        ...
        <el-col :xs="24" :md="14" :lg="8">
          <el-card style="box-shadow: 0 !important;">
            <el-row type="flex" justify="space-between" style="align-items: center;">
              ...
              <el-button style="border: 0; color: #191B1F" circle type="text">
            ...
            <div style="margin-top: 16px">
              <el-row type="flex" justify="space-between" style="align-items: center; padding: 2px 20px">
                ...
                <h2 style="margin: 0; font-size: 12px; color: #757679;  text-align: right; font-weight: 500 !important; ">
                  Balance: 21 <a style="color: #555CFF; text-decoration: underline">Max</a>
                </h2>
              </el-row>
              <div>
                <div style="background: #F3F3F3; border-radius: 20px; padding: 24px 20px; padding-bottom: 5px">
                  <el-row type="flex">
                    <dex-dropdown :items="dropdownItems" :value="input" :onChange="handleInputDropChange" />
                    <div style="flex: 1;">
                      <input placeholder="VALUE" class="input-elem" type="number" />
                    </div>
                  </el-row>
                  <h2 style="margin: 10px 0 0 0; font-size: 12px; color: #757679; font-weight: 500 !important; text-align: right ">~ $3.25</h2>
                </div>
              </div>

              <el-row style="margin: 16px 0; width: 100%" type="flex" justify="center">
