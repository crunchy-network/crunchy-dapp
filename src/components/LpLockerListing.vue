              ...
              <div class="grid-content" style="height: 100%">
                ...
                >
                  ...
                  >
                    {{
                      vueNumberFormat(
                        lpLockers.totalTvlTez * lpLockers.usdVwap,
                        {
                          prefix: "$",
                          decimal: ".",
                          thousand: ",",
...
export default {
  ...
  computed: {
    ...
    totalTokens: function () {
      return Object.values(this.lpLockers.data)
        .reduce((prev, current) => {
    ...
    totalTvlTezPct: function () {
      return (
        (this.lpLockers.totalTvlTez / this.totalLiquidityTez) *
        100
      ).toFixed(1);
    },
  },
