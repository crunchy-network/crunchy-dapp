        ...
        <el-row :gutter="20" type="flex" align="top" style="margin-top: 25px;">
                    ...
                    <template v-if="mode === 'mint'">
                      ...
                      <div class="current-balance" style="border-radius: 22px; background: #FFEECC; padding: 12px 20px;">
                        <el-row type="flex" align="middle" justify="space-between">
                          ...
                          <el-col :span="16" style="font-size: 12px; color: #303133; font-weight: bold; text-align: right;">{{ vueNumberFormat(wallet.balance.toNumber() / 1000000) }} ꜩ</el-col>
                        </el-row>
                      </div>
                    </template>

                    <template v-if="mode === 'burn'">
                      <el-avatar src="https://ipfs.fleek.co/ipfs/bafybeidwsid6fvv4vxbqja7er3b4exsht5r7umv6hpz7rc3ujg7xilhwv4" shape="circle" :size="38" style="position: absolute; top: 0; right: 10px;"></el-avatar>
                      <el-form-item
                        ...
                        key="input-wtz"
                      >
                        <el-input v-model="form.inputWtz" label="WTZ Input" @input="form.outputXtz = calcWtzToXtz(form.inputWtz)">
                          <span slot="suffix">
                            <el-button type="text" size="small" style="color: #1EC37F; font-weight: bold;" @click="form.inputWtz = wtz.balance; form.outputXtz = calcWtzToXtz(form.inputWtz)">USE MAX</el-button>
                          </span>
                        </el-input>
                      </el-form-item>
                      <div class="current-balance" style="border-radius: 22px; background: #FFEECC; padding: 12px 20px;">
                        <el-row type="flex" align="middle" justify="space-between">
                          <el-col :span="8" style="color: #8C8477; font-size: 12px; font-weight: bold;">BALANCE</el-col>
                          <el-col :span="16" style="font-size: 12px; color: #303133; font-weight: bold; text-align: right;">{{ vueNumberFormat(wtz.balance) }} WTZ</el-col>
                        </el-row>
                      </div>
                    </template>
                  ...
                  <el-col :span="10" style="position: relative;">
                    ...
                    <template v-if="mode === 'mint'">
                      ...
                      <el-form-item
                        ...
                        style="margin-bottom: 24px;"
                      >
                        <el-input v-model="form.outputWtz" label="1 WTZ = 1 XTZ" :disabled="true">
                          <span slot="suffix">WTZ</span>
                        </el-input>
                      </el-form-item>
                      <el-button @click="wtzWrap(form.inputXtz)" type="primary" style="border-radius: 12px; font-weight: bold; width: 100%; padding: 12px 20px; margin-left: 0;">MINT WTZ</el-button>
                    </template>
                    ...
                    <template v-if="mode === 'burn'">
                      ...
                      <el-form-item
                        ...
                        style="margin-bottom: 24px;"
                      >
                        <el-input v-model="form.outputXtz" label="1 XTZ = 1 WTZ" :disabled="true">
                          <span slot="suffix">XTZ</span>
                        </el-input>
                      </el-form-item>
                      <el-button @click="wtzUnwrap(form.inputWtz)" type="primary" style="border-radius: 12px; font-weight: bold; width: 100%; padding: 12px 20px; margin-left: 0;">REDEEM XTZ</el-button>
                    </template>
          ...
          <el-col :span="8">
            <div class="grid-content" style="height: 100%;">
              <el-card v-if="showUsd === true" v-loading="wtz.loading" class="box-card" shadow="never" style="height: 100%;">
                ...
                <div style="font-size: 24px; font-weight: bold; margin-top: 14px; margin-bottom: 8px;">
                  {{ vueNumberFormat(wtz.totalTvlTez * wtz.usdVwap, {prefix: '$', decimal: '.', thousand: ',', precision: 2}) }}
                </div>
                <h2 style="color: #191B1F; opacity: 0.4; font-size: 14px; margin-bottom: 0px;">Total Wrapped Value USD</h2>
              </el-card>
              <el-card v-if="showUsd === false" v-loading="wtz.loading" class="box-card" shadow="never" style="height: 100%;">
                ...
                <h2 style="color: #191B1F; opacity: 0.4; font-size: 14px; margin-bottom: 0px;">Total Wrapped Value XTZ</h2>
              </el-card>
            </div>
          </el-col>
        </el-row>
